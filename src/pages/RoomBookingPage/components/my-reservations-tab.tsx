      ...
      <Suspense fallback={<div>Loading...</div>}>
        <SuspenseQueries queries={[useReservations()]}>
          {([{ data: reservations }]) => {
            ...
            return (
              <>
                <ReservationList reservations={reservations} renderItem={(reservation) => {
                  ...
                  return (
                    <ReservationCard key={reservation.id}>
                      <ReservationCard.Header>
                        ...
                        <ReservationCard.Info date={reservation.date} startTime={reservation.start} endTime={reservation.end} capacity={reservation.attendees} />
                      ...
                      >
                        {(mutation) => (
                          <ReservationCard.CancelButton onCancel={() => mutation.mutate()} disabled={mutation.isPending} />
                        )}
                      </Mutation>
                    </ReservationCard>
                  );
